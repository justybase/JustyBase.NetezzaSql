...
public enum NzToken
{
    ...
    // Db2-specific tokens (produced only by Db2Lexer; registered before the
    // shared chain). Order mirrors db2OnlyTokens in the reference lexer.ts.
    Db2OptimizeFor,              // OPTIMIZE FOR
    Db2WithUr,                   // WITH UR
    Db2WithCs,                   // WITH CS
    Db2WithRs,                   // WITH RS
    Db2WithRr,                   // WITH RR
    Db2ForReadOnly,              // FOR READ ONLY
    Db2ForUpdate,                // FOR UPDATE
    Db2FinalTable,               // FINAL TABLE
    Db2OldTable,                 // OLD TABLE
    Db2NewTable,                 // NEW TABLE
    Db2ModifiedBy,               // MODIFIED BY
    Db2DeclareGlobalTemporary,   // DECLARE GLOBAL TEMPORARY
    Db2GeneratedAlways,          // GENERATED ALWAYS
    Db2GeneratedByDefault,       // GENERATED BY DEFAULT
    Db2OrganizeBy,               // ORGANIZE BY
    Db2DataCapture,              // DATA CAPTURE
    Db2CurrentSchema,            // CURRENT SCHEMA
    Db2CurrentServer,            // CURRENT SERVER
    Db2CurrentDate,              // CURRENT DATE
    Db2CurrentTime,              // CURRENT TIME
    Db2CurrentTimestamp,         // CURRENT TIMESTAMP
    Db2CurrentUser,              // CURRENT USER
    Db2LanguageSql,              // LANGUAGE SQL
