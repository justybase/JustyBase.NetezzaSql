...
// --dialect netezza|oracle|db2|mssql|mysql|postgresql selects the default SQL dialect; clients
// can switch it at runtime with the justy/setDialect request.
// Accepts both --dialect=oracle and --dialect oracle (likewise db2/mssql/mysql/postgresql).
